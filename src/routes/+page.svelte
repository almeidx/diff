...
<div class="home">
	...
	<header class="header">
		...
		<div class="header-right">
			<a href="https://github.com/almeidx/diff" class="header-link" target="_blank" rel="noopener" title="GitHub">
	...
	<main id="main-content" class="main">
		...
		<form class="compare-form" onsubmit={handleSubmit}>
			<div class="type-selector">
				...
				<button type="button" class="type-btn" class:active={packageType === "wp"} onclick={() => (packageType = "wp")}>
					<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
						<path
			...
			<div class="version-inputs">
				...
				{:else}
					<div class="form-group">
						...
						<input type="text" id="from-version" bind:value={fromVersion} placeholder="e.g. 1.0.0" />
					</div>
					<span class="arrow">→</span>
					<div class="form-group">
						<label for="to-version">To version</label>
						<input type="text" id="to-version" bind:value={toVersion} placeholder="e.g. 2.0.0" />
					</div>
				{/if}
			</div>
		...
		<div class="local-notice">
			...
			<p><a href="https://github.com/almeidx/diff" target="_blank" rel="noopener">View on GitHub</a></p>
		</div>
	</main>
</div>
